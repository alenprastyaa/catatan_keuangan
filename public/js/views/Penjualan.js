    ...
    <div>
      ...
      <Modal :show="showFormModal" size="lg" :title="form.id ? 'Edit Penjualan' : 'Tambah Penjualan'" @close="showFormModal = false">
        <form @submit.prevent="save">
          ...
          <p style="text-align:right;font-weight:600;margin-top:12px">Volume: {{ formVolume }} L &nbsp;|&nbsp; Total: {{ rupiah(formTotal) }}</p>
      ...
      <Modal :show="showDetailModal" size="lg" title="Detail Penjualan" @close="showDetailModal = false">
        <div v-if="detail">
          ...
          <div class="transaction-metrics"><span><b>Volume:</b> {{ Number(detail.volume_pagi || 0) + Number(detail.volume_sore || 0) }} L (Pagi {{ detail.volume_pagi || 0 }} / Sore {{ detail.volume_sore || 0 }})</span></div>
